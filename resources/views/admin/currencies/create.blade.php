                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-group">
                                ...
                                <input class="form-control" id="symbol" type="text" name="symbol" value="{{ old('symbol') }}">
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-group">
                                ...
                                <input class="form-control" id="money_format_thousands" type="text" name="money_format_thousands" value="{{ old('money_format_thousands') }}">
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-group">
                                ...
                                <input class="form-control" id="money_format_decimal" type="text" name="money_format_decimal" value="{{ old('money_format_decimal') }}">
